...
namespace kyedumper {
constexpr int64_t timestamp = 1654857982;
namespace netvars {
...
constexpr uintptr_t m_bShouldGlow = 0x29D8;
...
constexpr uintptr_t m_hMyWeapons = 0x2F08;
...
constexpr uintptr_t m_iWeaponOrigin = 0x32D8;
...
constexpr uintptr_t m_nSkin = 0xA1C;
...
constexpr uintptr_t m_rgflCoordinateFrame = 0x474;
...
constexpr uintptr_t dwbSendPackets = 0xD81F2;
constexpr uintptr_t dwClientState = 0x58BFDC;
...
constexpr uintptr_t dwEntityList = 0x4DD7B1C;
constexpr uintptr_t dwForceAttack = 0x3207FDC;
constexpr uintptr_t dwForceAttack2 = 0x3207FE8;
constexpr uintptr_t dwForceBackward = 0x3208024;
constexpr uintptr_t dwForceForward = 0x3208018;
constexpr uintptr_t dwForceJump = 0x5281A64;
constexpr uintptr_t dwForceLeft = 0x3208030;
constexpr uintptr_t dwForceRight = 0x320803C;
constexpr uintptr_t dwGameDir = 0x62A900;
constexpr uintptr_t dwGameRulesProxy = 0x52F528C;
constexpr uintptr_t dwGetAllClasses = 0xDE5DAC;
constexpr uintptr_t dwGlobalVars = 0x58BCE0;
constexpr uintptr_t dwGlowObjectManager = 0x5320758;
constexpr uintptr_t dwInput = 0x52290F0;
constexpr uintptr_t dwInterfaceLinkList = 0x96BD44;
constexpr uintptr_t dwLocalPlayer = 0xDBB5CC;
constexpr uintptr_t dwMouseEnable = 0xDC12D8;
constexpr uintptr_t dwMouseEnablePtr = 0xDC12A8;
constexpr uintptr_t dwPlayerResource = 0x3206380;
constexpr uintptr_t dwppDirect3DDevice9 = 0xA5050;
constexpr uintptr_t dwRadarBase = 0x520C894;
constexpr uintptr_t dwSensitivity = 0xDC1174;
constexpr uintptr_t dwSensitivityPtr = 0xDC1148;
constexpr uintptr_t dwSetClanTag = 0x8A320;
constexpr uintptr_t dwViewMatrix = 0x4DC9434;
constexpr uintptr_t dwWeaponTable = 0x5229BB4;
constexpr uintptr_t dwWeaponTableIndex = 0x326C;
constexpr uintptr_t dwYawPtr = 0xDC0F38;
constexpr uintptr_t dwZoomSensitivityRatioPtr = 0xDC7720;
constexpr uintptr_t find_hud_element = 0x2DFA55B0;
constexpr uintptr_t force_update_spectator_glow = 0x3BD3FA;
constexpr uintptr_t interface_engine_cvar = 0x3E9EC;
constexpr uintptr_t is_c4_owner = 0x3CA470;
constexpr uintptr_t m_bDormant = 0xED;
constexpr uintptr_t m_flSpawnTime = 0x103C0;
constexpr uintptr_t m_pitchClassPtr = 0x520CB30;
constexpr uintptr_t m_pStudioHdr = 0x2950;
constexpr uintptr_t m_yawClassPtr = 0xDC0F38;
constexpr uintptr_t model_ambient_min = 0x58F054;
constexpr uintptr_t set_abs_angles = 0x1E5990;
constexpr uintptr_t set_abs_origin = 0x1E57D0;
} // namespace signatures
} // namespace kyedumper